...
namespace KSW.ATE01.Extension.Shared.Helpers
{
    ...
    internal static class SolutionHelper
    {
        ...
        internal static IEnumerable<ProjectItem> GetSelectedProjectItemsRecursively(ATE01Package package)
        {
        ...
        internal static IEnumerable<ProjectItem> GetSimilarProjectItems(ATE01Package package, ProjectItem projectItem)
        {
