...
namespace KSW.ATE01.Extension.Shared.Helpers
{
    ...
    internal static class UIHierarchyHelper
    {
        ...
        internal static IEnumerable<UIHierarchyItem> GetSelectedUIHierarchyItems(ATE01Package package)
        {
        ...
        internal static UIHierarchy GetSolutionExplorer(ATE01Package package)
        {
        ...
        internal static UIHierarchyItem GetTopUIHierarchyItem(ATE01Package package)
        {
            var solutionExplorer = GetSolutionExplorer(package);
