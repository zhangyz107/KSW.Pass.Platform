...
namespace KSW.ATE01.Extension.Shared.Helpers
{
    ...
    {
        private const string SettingsFilename = "ATE01Extension.config";
        ...
        private readonly ATE01Package _package;

        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsContextHelper" /> class.
        /// </summary>
        /// <param name="package">The hosting package.</param>
        private SettingsContextHelper(ATE01Package package)
        {
            _package = package;
        }
        ...
        internal static SettingsContextHelper GetInstance(ATE01Package package)
        {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Pass", SettingsFilename);
        }
