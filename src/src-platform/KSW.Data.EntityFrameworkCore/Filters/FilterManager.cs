...
namespace KSW.Data.EntityFrameworkCore.Filters;
...
public class FilterManager : IFilterManager
{
    ...
    public FilterManager(IContainerProvider containerProvider)
    {
    ...
    public IFilter GetFilter(Type filterType)
    {
        if (_filters.ContainsKey(filterType) == false)
        {
            ...
            var filter = _containerProvider.Resolve(serviceType);
