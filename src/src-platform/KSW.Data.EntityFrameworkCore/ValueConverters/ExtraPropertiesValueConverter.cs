...
using KSW.SystemTextJson;

namespace KSW.Data.EntityFrameworkCore.ValueConverters;
...
public class ExtraPropertiesValueConverter : ValueConverter<ExtraPropertyDictionary, string> {
    ...
    private static ExtraPropertyDictionary JsonToProperties( string json ) {
        ...
        return Helpers.Json.ToObject<ExtraPropertyDictionary>( json, options ) ?? new ExtraPropertyDictionary();
    }
}